...
const contracts = [
  ...
  ['compact preset filters', '.rd-controls { width:min(100%,720px);'],
  ...
  ['fullscreen expand arrows', "M10 10 4 4m0 0v5m0-5h5M14 14l6 6"],
  ['fullscreen collapse arrows', "M4 4l6 6m0 0V5m0 5H5M20 20l-6-6"],
